...
import Mutual_number from "./mutual_number/mutual_number";
    ...
    fetch(
      ...
      .then((data) => {
        ...
        if (data?.code === "REQUEST_CREATE_OK") {
          props.setFriend_number( props.friend_number - 1);
          toast.show({
            render: ({ id }) => {
              return (
                <ToastAlert
        ...
        <VStack>
          <Flex direction="row" space="4" mb="2">
            <VStack>
              ...
              <HStack>
                <Mutual_number
                  emailS={props.emailS}
                  user_account_2={props.user_account_2}
                  codeS={props.codeS}
                ></Mutual_number>
              </HStack>
            </VStack>
          ...
          <HStack>
            ...
            <Button
              ...
              px="7"
              bgColor="gray.400"
              onPress={() => accept_declineFunction(0)}
            >
              Xóa
            </Button>
          </HStack>
