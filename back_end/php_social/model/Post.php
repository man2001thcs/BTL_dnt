...
class Post extends AppModel
{
            ...
            array(
                ...
                'conditions_or' => array(
                    'condition1' => array(
                        ...
                        "Friend_relation1.user_account_2" => "LIKE " . "'" . $account . "'",
                        "Friend_relation1.type" => "IN(0,1)",
                    ),
                    'condition2' => array(
                        'POST.publicity_state' => 2,
                        "Friend_relation1.user_account_2" => "is null",
                    ),
                    'condition3' => array(
                        'POST.publicity_state' => 2,
                        "Friend_relation1.user_account_2" => "LIKE " . "'" . $account . "'",
                        "Friend_relation1.type" => "IN(0,1,2)"
                    ),
                    'condition4' => array($this->alias . '.user_id' => $user_this->get_id($account)['id']),
                ),
    ...
    public function get_post_search($account, $search_body, $limit = 0)
    {
        $friend_relation = new Friend_relation();
        $user_this = new User();
            ...
            array(
                ...
                'conditions_or' => array(
                    'condition1' => array(
                        ...
                        $this->alias . '.post_body' => "LIKE '%" . $search_body . "%'",
                    ),
                    'condition2' => array(
                        'POST.publicity_state' => 2,
                        $this->alias . '.post_body' => "LIKE '%" . $search_body . "%'",
                    ...
                    'condition3' => array(
                        $this->alias . '.user_id' => $user_this->get_id($account)['id'],
                        $this->alias . '.post_body' => "LIKE '%" . $search_body . "%'"
                    ),
                ),
                'orders' => $this->alias . '.modified' . ' DESC',
